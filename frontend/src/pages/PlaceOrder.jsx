  ...
  return (
    ...
    {/*....left side.... */}
      <div className="flex flex-col gap-4 w-full sm:max-w-[480px]">
         ...
         <div className="flex gap-3">
         <input required onChange={onChangeHandler} name='zipcode' value={formData.zipcode} className='border border-gray-400 rounded py-1.5 px-3.5 w-full' type="number" placeholder='Zip Code' /> 
        ...
        <div className="mt-12">
           ...
           <div className="flex flex-col gap-3 lg:flex-row">
                ...
                <div onClick={()=>setMethod('cod')} className="flex items-center gap-3 p-2 px-3 border cursor-pointer">
                  ...
                  <p className='mx-4 text-sm font-medium text-gray-600'>CASH ON DELIVERY</p>
                </div>
           </div>
           <div className="w-full mt-8 text-end">
             <button type='submit' className='px-16 py-3 text-sm text-white bg-black active:bg-gray-700'>PLACE ORDER</button>
           </div>
        </div>
      </div>
    </form>
